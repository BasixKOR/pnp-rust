...
## [0.12.6](https://github.com/BasixKOR/pnp-rust/compare/v0.12.5...v0.12.6) - 2025-12-14

### Other

- *(deps)* update rust crate fancy-regex to ^0.17.0 ([#80](https://github.com/BasixKOR/pnp-rust/pull/80))
- *(deps)* update dependency rust to v1.92.0 ([#79](https://github.com/BasixKOR/pnp-rust/pull/79))
- *(deps)* update rust crate criterion to v0.8.1 ([#78](https://github.com/BasixKOR/pnp-rust/pull/78))
- *(deps)* update yarn to v4.12.0 ([#77](https://github.com/BasixKOR/pnp-rust/pull/77))
- *(deps)* update rust crate criterion to 0.8 ([#76](https://github.com/BasixKOR/pnp-rust/pull/76))
- *(deps)* update dependency rust to v1.91.1 ([#75](https://github.com/BasixKOR/pnp-rust/pull/75))
- *(deps)* lock file maintenance ([#73](https://github.com/BasixKOR/pnp-rust/pull/73))
- *(deps)* update yarn to v4.11.0 ([#72](https://github.com/BasixKOR/pnp-rust/pull/72))
