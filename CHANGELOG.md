...
## [0.12.9](https://github.com/BasixKOR/pnp-rust/compare/v0.12.8...v0.12.9) - 2026-05-11

### Fixed

- *(util)* keep drive prefix sticky when `..` overshoots drive root ([#104](https://github.com/BasixKOR/pnp-rust/pull/104))

### Other

- *(deps)* update rust crate fancy-regex to ^0.18.0 ([#103](https://github.com/BasixKOR/pnp-rust/pull/103))
- *(deps)* update yarn to v4.14.1 ([#102](https://github.com/BasixKOR/pnp-rust/pull/102))
- *(deps)* update yarn to v4.14.0 ([#101](https://github.com/BasixKOR/pnp-rust/pull/101))
- *(deps)* update dependency rust to v1.95.0 ([#100](https://github.com/BasixKOR/pnp-rust/pull/100))
