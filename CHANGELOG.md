...
## [0.12.2](https://github.com/BasixKOR/pnp-rust/compare/v0.12.1...v0.12.2) - 2025-08-25

### Other

- *(deps)* lock file maintenance rust crates ([#45](https://github.com/BasixKOR/pnp-rust/pull/45))
- add recived path into panic info ([#46](https://github.com/BasixKOR/pnp-rust/pull/46))
