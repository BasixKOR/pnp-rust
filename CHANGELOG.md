...
## [0.12.8](https://github.com/BasixKOR/pnp-rust/compare/v0.12.7...v0.12.8) - 2026-01-14

### Fixed

- preserve order in `packageRegistryData` using `IndexMap` ([#86](https://github.com/BasixKOR/pnp-rust/pull/86))
