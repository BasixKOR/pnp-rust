...
## [0.12.0](https://github.com/BasixKOR/pnp-rust/compare/v0.11.0...v0.12.0) - 2025-07-04

### Other

- change `find_closest_pnp_manifest_path` from recursion to a loop ([#35](https://github.com/BasixKOR/pnp-rust/pull/35))
